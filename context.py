...
ROUTE_DESCRIPTIONS = {
    "SERVICE_INFO": "서비스 종류, 가격, 견적, 작업 기간, 패키지 비교, 포함 항목, 프로젝트 진행 상황, 담당 디자이너 등 서비스 및 프로젝트 일반 정보 문의",
    "REVISION": "시안 수정 횟수, 추가 수정 비용, 수정 범위, 피드백 방법, 피드백 기한, 컨셉 변경 비용 등 수정 관련 문의",
